...
export const routes={valley:{name:'山谷穿越 · 3 km',scale:12,offset:[0,0] as [number,number]},plateau:{name:'高原巡检 · 3 km',scale:16,offset:[260,-180] as [number,number]},ridge:{name:'山脊环线 · 3 km',scale:10,offset:[-210,240] as [number,number]}} as const;
